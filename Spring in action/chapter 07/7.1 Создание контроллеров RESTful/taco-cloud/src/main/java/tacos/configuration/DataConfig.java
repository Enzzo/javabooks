...
// Загружаем данные в базу при помощи CommandLineRunner
@Configuration
public class DataConfig {
	...
	CommandLineRunner dataLoader(
		...
		return args -> {
			Ingredient flourTortilla = new Ingredient("FLTO", "Flouraaa Tortilla", Type.WRAP);
			...
			taco3.setIngredients(Arrays.asList(flourTortilla, cornTortilla, tomatoes, lettuce, salsa, cheddar));
			tacoRepo.save(taco3);
		};
	}
}